...
public enum ErrorInfo {
     ...
     * already exist
     */
    USER_ALREADY_EXIST(61002, "Username already exists.", "用户名已存在"),

    /**
     * not found in db
     */
    NOT_FOUND(61003,"Username not found. Please try again.", "用户名未找到，请重试"),
     ...
     * 无效的密码
     */
    INVALID_PASSWORD(61024, "Wrong password. Please try again.", "密码错误"),

    /**
     * ONT ID 已经锁住，请24小时后再试
     */
